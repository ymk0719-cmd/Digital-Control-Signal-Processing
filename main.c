...
#define TRI_AMPLITUDE   (double)(1.5)
#define TRI_PERIOD      (double)(10.0)
...
#define K_LIN       (double)(9.2830)       // TODO: replace with MATLAB K

/* CW polynomial:  omega = P_CW_A*Vc^2 + P_CW_B*Vc + P_CW_C */
#define P_CW_A      (double)(-3.1977)       // TODO: replace with p_cw(1)
#define P_CW_B      (double)(35.8756)       // TODO: replace with p_cw(2)
#define P_CW_C      (double)(-73.4056)       // TODO: replace with p_cw(3)

/* CCW polynomial: omega = P_CCW_A*Vc^2 + P_CCW_B*Vc + P_CCW_C */
#define P_CCW_A     (double)(3.1681)       // TODO: replace with p_ccw(1)
#define P_CCW_B     (double)(3.8510)       // TODO: replace with p_ccw(2)
#define P_CCW_C     (double)(-25.9250)       // TODO: replace with p_ccw(3)
